        ...
        return (
            <div>
                <Plot
                    ...
                    layout = {{width: 1000, height: 600, title: `Number of Vaccinations Cases over Time in ${this.transformData(this.state.data)['q'][0]}`, xaxis: {type: 'date', title: 'Date (MMM-YYYY)'}, yaxis:{title: 'Number of Cases (Monthly)'}}}
                />
            </div>
        )
    }
